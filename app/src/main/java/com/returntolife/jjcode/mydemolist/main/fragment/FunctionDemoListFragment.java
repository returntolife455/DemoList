 ...
 * version:1.0.0
 */
public class FunctionDemoListFragment extends BaseDemoListFragment {


    public static BaseDemoFragment getInstance(){
        return new FunctionDemoListFragment();
    }

    @Override
    public List<DemoListBean> initData() {
        return DemoListDataManager.getInstance().getFunctionDemoList();
    }
}
