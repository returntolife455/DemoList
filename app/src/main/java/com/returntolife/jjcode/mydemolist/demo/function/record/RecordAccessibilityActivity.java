...
import com.returntolife.jjcode.mydemolist.demo.function.accessibility.MyAccessibilityService;
 ...
 * Version: 1.0
 */
public class RecordAccessibilityActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onResume() {
        ...
        boolean isStartService=isAccessibilitySettingsOn(this, CallAccessibilityService.class.getName());
        mTvConnectStatue.setText("sAccessibilitySettingsOn："+isStartService);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_goto_setting) {
